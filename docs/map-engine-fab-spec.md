...
- The custom runtime now has verified end-to-end coverage for the core shipped FAB flows and remains a development surface for default-runtime risk management, not because those flows are still unverified.
...
- runtime selection through the `customMapEngine` development surface
...
The custom runtime can remain a development surface while rollout risk is
...
this spec, the documentation is incomplete.
